...
public class BookUpdateDTO //La class BookUpdateDTO permet de renvoyer certaine informations à l'utilisateur sur des données sensibles ou bien effectuer des vérifications sur les valeurs
{
